...
//   // Get sub-units for selected department
...
//   // Reset sub-unit filter when department changes
//   useEffect(() => {
...
//               className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0088D0] focus:border-transparent transition-all"
//             />
//           </div>
